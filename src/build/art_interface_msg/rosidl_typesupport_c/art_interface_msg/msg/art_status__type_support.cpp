...
static const _ArtStatus_type_support_symbol_names_t _ArtStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, art_interface_msg, msg, ArtStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, art_interface_msg, msg, ArtStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, art_interface_msg, msg, ArtStatus)() {
  return &::art_interface_msg::msg::rosidl_typesupport_c::ArtStatus_message_type_support_handle;
}
